    ...
    <div class="card sameheight-item items" data-exclude="xs,sm,lg">
      <div class="card-header bordered">
        <div class="header-block">
          <h3 class="title"><?php echo lang('admin button beneficiaries_all'); ?></h3>
        </div>
        ...
        <table class="table table-striped table-bordered table-hover">
          <thead>
            ...
            <tr>
                ...
                <th>
                    <a href="<?php echo current_url(); ?>?sort=user&dir=<?php echo (($dir == 'asc' ) ? 'desc' : 'asc'); ?>&limit=<?php echo $limit; ?>&offset=<?php echo $offset; ?><?php echo $filter; ?>"><?php echo lang('users col addedBy'); ?></a>
                                                            ...
                                                            <div class="row">
                                                              <div class="col-md-6">
                                                                <div class="form-group" style="margin-bottom:1rem"> 
                                                                  <label class="control-label"><?php echo lang('users input id'); ?></label>
                                                                    <?php echo form_input(array('name'=>'user', 'id'=>'id', 'class'=>'form-control underlined', 'placeholder'=>lang('users input added_by'), 'value'=>set_value('user', ((isset($filters['user'])) ? $filters['user'] : '')))); ?>
                                                                </div>
                                                              </div>
                                                              <div class="col-md-6">
